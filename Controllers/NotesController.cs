...
namespace MVCNotes.Controllers
{
    public class NotesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Text,CreationTime")] Note note)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Text,CreationTime")] Note note)
        {
            if (id != note.Id)
            {
                return NotFound();
